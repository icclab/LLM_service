...
class ImageSub(Node):
    def __init__(self):
        ...
        self.service = self.create_service(CheckImage, 'check_leakage', self.handle_check_leakage)
    ...
    def detect_leakage(self, pil_image):
        ...
        # question = '<image>\nPlease check the image properly, if there is any leakage, find it and tell me in the percentage of the pixels of the image, if no, just simply answer NO without anything extra..'
        question = '<image>\nPlease describe the image, if there is any leakage or any person, find it and alert me by only answer YES, there is a person!!'
